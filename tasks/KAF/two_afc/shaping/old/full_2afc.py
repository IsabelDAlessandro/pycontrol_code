...
# Rwd sizing
# For rwd durn multplier of 1, 1 mL ~ 125 rewards. 200??
# For rwd durn multiplier of 0.75, ~ 225 rewards.
pc.v.reward_duration_multiplier = 1 #removed the 0.8 multiplier
pc.v.n_allowed_rwds = 200  # total per session
pc.v.reward_durations = rwd_durations #[30, 30]  # Reward delivery duration (ms) [left, right].
...
pc.v.min_nose_out_duration = 0.75 * pc.second #get rid of this
