...
# Block counters
pc.v.n_allowed_rwds_per_block = 3 #change depending on above def
...
pc.v.timeout_duration = 1.5 * pc.second
pc.v.timeout_early_ms = 500# penalty for EARLY side pokes (during wait_for_center_poke)
pc.v.timeout_wrong_ms = 1500   # penalty for WRONG choice after a valid center hold
