...
from hardware_definition import right_port, left_port, center_port, final_valve_ttl,final_valve, odor_A, odor_B, rwd_durations, sync_out #thermistor_sync, speaker,
...
def inter_trial_interval(event):
    ...
    # Optional: extend ITI if still licking rewarded spout in the first half
    elif (
        pc.v.outcome
        and (
