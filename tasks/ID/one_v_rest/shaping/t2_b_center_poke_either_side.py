...
from hardware_definition import right_port, left_port, center_port, final_valve, thermistor_sync, camera_sync,rwd_durations
...
#----------------------------VARIABLES TO EDIT------------------------------------
pc.v.n_allowed_rwds = 240  # total per session (assuming a 5uL reward size)
#---------------------------------------------------------------------------------
